      ...
      <div className="flex-1 ml-auto">
        ...
        <main className="max-w-7xl mx-auto px-4 transition-all duration-500 mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card
              name="Send"
              paragraph="Easily send tokens to any wallet address."
              buttonText="Send Now"
              imageSrc="/send-token.png"
              onClick={() => setPopoverType("Send")}
            />
            <Card
              name="Receive"
              paragraph="Generate your wallet address or QR to receive tokens."
              buttonText="Receive Tokens"
              imageSrc="/receive-token.png"
              onClick={() => setPopoverType("Receive")}
            />
            <Card
              name="Buy"
              paragraph="Purchase your favorite tokens quickly and securely."
              buttonText="Buy Tokens"
              imageSrc="/buy-token.png"
              onClick={() => setPopoverType("Buy")}
            />
            <Card
              name="Drop"
              paragraph="Easily send your tokens to friends or anyone for free."
              buttonText="Drop Tokens"
              imageSrc="/drop-token.png"
              onClick={() => setPopoverType("Drop")}
            />
          </div>
